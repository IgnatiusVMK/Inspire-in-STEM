...
#dictionary2; person
person = {'name':'Ignacio_marley','gender':'Male','phone_number':'+254790884584','address':'67891 K-Sukari'}
person['age'] = '19'
...
for key, value in person.items():
    print(f"{value}:{key}")
# Dictionaries in Dictionaries,Lists in Dictionaries,Dictionaries in lists